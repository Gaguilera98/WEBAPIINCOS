...
namespace WebApiINCOS.Controllers
{
        ...
        {
            private NegEstudiante _model;

            public EstudianteController()
            {
                _model = new NegEstudiante();
            }

            public EstudianteController(NegEstudiante model)
            {
                _model = model;
            }
            ...
            [Route("insertar")]
            public IHttpActionResult insertar([FromBody] EstudianteTR param)
            {
            #region Validaciones
            ...
            [Route("modificar")]
            public IHttpActionResult modificar([FromBody] EstudianteTR param)
            {
                #region Validaciones
        ...
        public IHttpActionResult eliminar(int codigo)
        {
            ...
            [HttpGet]
            [ResponseType(typeof(EstudianteTR))]
            [Route("obtener/{cod}")]
            ...
            [HttpGet]
            [ResponseType(typeof(List<EstudianteTR>))]
            [Route("listar")]
