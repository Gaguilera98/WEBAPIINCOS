...
namespace WebApiINCOS.Controllers
{
        ...
        [RoutePrefix("api/paraleli")]
        public class ParaleloController : ApiController

        {
            private NegParalelo _model;

            public ParaleloController()
            {
                _model = new NegParalelo();
            }

            public ParaleloController(NegParalelo model)
            {
                _model = model;
            }
            ...
            [Route("insertar")]
            public IHttpActionResult insertar([FromBody] ParaleloTR param)
            {
                #region Validaciones
            ...
            [Route("modificar")]
            public IHttpActionResult modificar([FromBody] ParaleloTR param)
            {
                #region Validaciones
            ...
            [HttpGet]
            [ResponseType(typeof(ParaleloTR))]
            [Route("obtener/{cod}")]
            public IHttpActionResult obtener(int cod)
            {
                ...
                var result = _model.ObtenerP(cod);
            ...
            [HttpGet]
            [ResponseType(typeof(List<ParaleloTR>))]
            [Route("listar")]
